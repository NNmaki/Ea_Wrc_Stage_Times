...
try {
    ...
    $queryStojdraga = "SELECT * FROM croatia_stojdraga ORDER BY time ASC LIMIT 10;";
    $stmtStojdraga = $pdo->prepare($queryStojdraga);
    $stmtStojdraga->execute();
    $resultsStojdraga = $stmtStojdraga->fetchAll(PDO::FETCH_ASSOC);

    $queryHartje = "SELECT * FROM croatia_hartje ORDER BY time ASC LIMIT 10;";
    $stmtHartje = $pdo->prepare($queryHartje);
    $stmtHartje->execute();
    $resultsHartje = $stmtHartje->fetchAll(PDO::FETCH_ASSOC);

    $queryKrasic = "SELECT * FROM croatia_krasic ORDER BY time ASC LIMIT 10;";
    $stmtKrasic = $pdo->prepare($queryKrasic);
    $stmtKrasic->execute();
    $resultsKrasic = $stmtKrasic->fetchAll(PDO::FETCH_ASSOC);
    ...
    <div id="main-container" class="main-container">
        <div class="overlay">
            ...
            <div class="stage-container">    
                <h3>STOJDRAGA 10.24km</h3> 
                <h5>(FIRST THIRD OF BLIZNEC STAGE)</h5>
                <h5>TOP TEN FASTEST TIMES</h5>
                <?php if (empty($resultsStojdraga)): ?>
                ...
                <table class="time-table">
                    ...
                    <tbody>
                        <?php  $rank = 1;
                        foreach ($resultsStojdraga as $row): ?>
                        <tr>
                        <td><?= $rank ?></td>
                ...
                <?php endif; ?>
                <button class="basic-button" onclick="openNewRecord('croatia_stojdraga', 'STOJDRAGA', '10.24km', 'FIRST THIRD OF BLIZNEC STAGE')">ADD NEW</button>
                <button class="basic-button" onclick="showAllTimes('croatia_stojdraga', 'STOJDRAGA', '10.24km', 'FIRST THIRD OF BLIZNEC STAGE')">SHOW ALL</button>
            </div>
            ...
            <div class="stage-container">    
                <h3>HARTJE 7.79km</h3> 
                <h5>(SECOND THIRD OF BLIZNEC STAGE)</h5>
                <h5>TOP TEN FASTEST TIMES</h5>
                <?php if (empty($resultsHartje)): ?>
                <p>No records at the moment</p>
                <?php else: ?>
                    <table class="time-table">
                    <thead>
                ...
                <?php endif; ?>
                <button class="basic-button" onclick="openNewRecord('croatia_hartje', 'HARTJE', '7.79km', 'SECOND THIRD OF BLIZNEC STAGE')">ADD NEW</button>
                <button class="basic-button" onclick="showAllTimes('croatia_hartje', 'HARTJE', '7.79km', 'SECOND THIRD OF BLIZNEC STAGE')">SHOW ALL</button>
            </div>
            ...
            <div class="stage-container">    
                <h3>KRASIC 8.77km</h3> 
                <h5>(FINAL THIRD OF BLIZNEC STAGE)</h5>
                <h5>TOP TEN FASTEST TIMES</h5>
                <?php if (empty($resultsKrasic)): ?>
                <p>No records at the moment</p>
                <?php else: ?>
                    <table class="time-table">
                    <thead>
                ...
                <?php endif; ?>
                <button class="basic-button" onclick="openNewRecord('croatia_krasic', 'KRASIC', '8.77km', 'FINAL THIRD OF BLIZNEC STAGE')">ADD NEW</button>
                <button class="basic-button" onclick="showAllTimes('croatia_krasic', 'KRASIC', '8.77km', 'FINAL THIRD OF BLIZNEC STAGE')">SHOW ALL</button>
            </div>
